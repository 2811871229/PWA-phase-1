...
function education(e){
    ...
    table.border="1";
    var tr1="<tr><td>sno</td><td>degree</td><td>institute</td><td>percentage</td><td>year</td></tr>";
    var tr2="";
    for (i=0;i<e.length;i++)
     {
        tr2=tr2+"<tr><td>"+e[i].sno+"</td><td>"+e[i].degree+"</td><td>"+e[i].institute+"</td><td>"+e[i].percentage+"</td><td>"+e[i].year+"</td></tr>";
    }
...
function language(e){
    ...
    ee.textContent=" languages known";
